...
P1_SCORE_Y = WINDOW_HEIGHT - (50 + LETTERBOX_HEIGHT)

P1_SCORE_SPRITE_X = 10
P1_SCORE_SPRITE_Y = WINDOW_HEIGHT - (40 + LETTERBOX_HEIGHT)

P2_SCORE_X = WINDOW_WIDTH - (SCORE_SPRITE_WIDTH + SCORE_WIDTH)
P2_SCORE_Y = WINDOW_HEIGHT - (50 + LETTERBOX_HEIGHT)

P2_SCORE_SPRITE_X = WINDOW_WIDTH - 10
P2_SCORE_SPRITE_Y = WINDOW_HEIGHT - (40 + LETTERBOX_HEIGHT)
